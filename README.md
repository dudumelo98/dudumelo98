...
Portfólio de 30 projetos de ciência de dados, ordenado por impacto de negócio e complexidade técnica.

| # | Projeto | Resultado |
|---|---|---|
| 1 | [Turnover / People Analytics](https://github.com/dudumelo98/turnover-people-analytics) | AUC 0,74, XGBoost + SHAP + Kaplan-Meier |
| 2 | [Manutenção Preditiva Industrial](https://github.com/dudumelo98/factory-guardian) | LSTM + Random Forest |
| 3 | [Previsão de Demanda e Estoque](https://github.com/dudumelo98/previsao-demanda-estoque) | Prophet, MAPE 6% |
| 4 | [Churn Prediction](https://github.com/dudumelo98/Previsao_Churn_XGBoost_91_Recall) | XGBoost, recall 91% |
| 5 | [Risco Fiscal e Compliance](https://github.com/dudumelo98/risco-fiscal-compliance) | AUC 0,84 + NLP |
| 6 | [Score de Crédito](https://github.com/dudumelo98/score-credito-empresarial) | dado real UCI, AUC 0,77 |
| 7 | [BI de Saúde Hospitalar](https://github.com/dudumelo98/bi-saude-hospitalar) | previsão de leitos + risco de readmissão |
